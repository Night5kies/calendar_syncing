...
class MockRepository {
  AppState buildInitialState() {
    ...
    final request = MeetingRequest(
      ...
      daysOfWeek: const ['Mon', 'Wed', 'Thu'],
      timesOfDay: const ['Morning', 'Afternoon'],
  ...
  List<TimeSlot> buildMockSlots(DateTime baseDate) {
    return [
      TimeSlot(
        ...
        score: 92,
        explanation: 'Strong overlap across all calendars.',
      ),
      TimeSlot(
        id: 's2',
        ...
        score: 86,
        explanation: 'Minor conflicts, still workable.',
      ),
      TimeSlot(
        id: 's3',
        ...
        score: 78,
        explanation: 'Late-day option with two attendees flexible.',
      ),
    ];
  }
}
